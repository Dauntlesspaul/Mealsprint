...
function Meat() {
    ...
    useEffect(()=>{
      ...
      const isMeat = foodItems.filter(item=> item.category === 'meat')
  return (  
        <div>
            <div className='text-white text-lg md:text-xl xl:text-2xl mb-2 font-semibold'>Meat Dishes</div>

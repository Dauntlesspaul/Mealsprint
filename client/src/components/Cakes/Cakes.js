...
function Cakes() {
    ...
    useEffect(()=>{
      ...
      const isCakes = foodItems.filter(item=> item.category === 'cakes')
  return (  
        <div>
            <div className='text-white text-lg md:text-xl xl:text-2xl mb-2 font-semibold'>Cakes </div>

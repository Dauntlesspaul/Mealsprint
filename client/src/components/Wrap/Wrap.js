...
function Wraps() {
    ...
    useEffect(()=>{
      ...
      const isWraps = foodItems.filter(item=> item.category === 'wrap')
  return (  
        <div>
            <div className='text-white text-lg md:text-xl xl:text-2xl mb-2 font-semibold'>Wraps </div>
